...
router.include_router(
    research_features_router,
)

router.include_router(
    research_datasets_router,
)


router.include_router(
    research_factor_panels_router,
)

router.include_router(
    research_factor_returns_router,
)

router.include_router(
    research_factor_return_methodology_router,
)

router.include_router(
    research_factor_evaluations_router,
)

router.include_router(
    research_signals_router,
)
...
router.include_router(
    research_portfolio_risk_router,
)
...
router.include_router(
    research_portfolio_stress_router,
)

router.include_router(
    research_portfolio_rebalance_router,
)

router.include_router(
    research_portfolio_transaction_cost_router,
)

router.include_router(
    research_backtests_router,
)
